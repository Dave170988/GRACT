    ...
    <?php 
     ...
     <div class="container mt-5">
        ...
        <label for="profile-pic" style="cursor: pointer;">
            <img id="profile-img" src="../img/teacher-<?=$teacher['gender']?>.png" class="card-img-top rounded-circle" alt="Profile Picture" style="width: 150px; height: 150px; object-fit: cover;">
