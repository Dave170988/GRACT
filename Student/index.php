...
<body>
    <?php 
     ...
     <label for="profile-pic" style="cursor: pointer;">
            <img id="profile-img" src="../img/teacher-<?=$student['gender']?>.png" class="card-img-top rounded-circle" alt="Profile Picture" style="width: 150px; height: 150px; object-fit: cover;">
    ...
    <script>
        $(document).ready(function(){
            ...
            // Highlight profile pic on hover
